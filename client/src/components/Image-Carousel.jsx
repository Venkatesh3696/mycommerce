    ...
    <div className="w-full px-4 md:px-0">
      <div className="w-full relative">
        ...
        >
          ...
          <CarouselPrevious className="absolute top-1/2 -translate-y-1/2 left-4 z-10 bg-white text-black cursor-pointer rounded-full p-1" />
          <CarouselNext className="absolute top-1/2 -translate-y-1/2 right-4 z-10  bg-white text-black cursor-pointer rounded-full p-1" />
        </Carousel>
      </div>
